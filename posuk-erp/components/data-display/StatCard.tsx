...
export function StatCard({ label, value, meta, accent }: StatCardProps) {
  return (
    <div style={{ background: accent ? "rgba(34,211,238,0.07)" : "rgba(255,255,255,0.03)", border: `1px solid ${accent ? "var(--border-strong)" : "var(--border)"}`, borderRadius: "var(--radius-sm)", padding: "1rem", display: "flex", flexDirection: "column", gap: "0.3rem" }}>
