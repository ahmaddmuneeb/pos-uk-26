...
type NavEntry = { key: string; label: string; icon: LucideIcon };
...
const NAV: { section: string; items: NavEntry[]; reports?: NavEntry[] }[] = [
  ...
  },
  {
    section: "Company",
    items: [
      { key: "/company/customers", label: "Customers", icon: Users },
      { key: "/company/custtypes", label: "Customer Types", icon: Tag },
      { key: "/company/receipts", label: "Customer Receipts", icon: Receipt },
      { key: "/company/salepersons", label: "Sale Persons", icon: UserCheck },
    ],
    reports: [
      { key: "/reports/ledger", label: "Ledger", icon: BookOpen },
      { key: "/reports/receivable", label: "Receivable", icon: Wallet },
    ],
  },
  {
    section: "Product",
    items: [
      { key: "/product/categories", label: "Categories", icon: Layers },
      { key: "/product/subcategories", label: "Sub Categories", icon: List },
      { key: "/product/products", label: "Products", icon: Package },
      { key: "/product/locations", label: "Stock Locations", icon: MapPin },
      { key: "/product/uoms", label: "UOM", icon: Ruler },
    ],
    reports: [
      { key: "/reports/stocksummary", label: "Stock Summary", icon: BarChart2 },
      { key: "/reports/currentstock", label: "Current Stock", icon: Box },
      { key: "/reports/stockledger", label: "Stock Ledger", icon: ClipboardList },
      { key: "/reports/productlist", label: "Product List", icon: PackageSearch },
      { key: "/reports/reorder", label: "Re-Order Level", icon: AlertTriangle },
    ],
  },
  {
    section: "Sales",
    items: [
      { key: "/sales/orders", label: "Sale Orders", icon: ShoppingCart },
      { key: "/sales/invoices", label: "Sale Invoices", icon: FileText },
      { key: "/sales/returns", label: "Sale Returns", icon: RotateCcw },
    ],
    reports: [
      { key: "/reports/saleregister", label: "Sale Register", icon: FileBarChart },
      { key: "/reports/returnregister", label: "Return Register", icon: FileX },
    ],
  },
  {
    section: "Administration",
    items: [
      { key: "/administration/branches", label: "Branches", icon: Building2 },
      { key: "/administration/users", label: "Users", icon: UserCog },
      { key: "/administration/roles", label: "Roles", icon: ShieldCheck },
      { key: "/administration/userrights", label: "User Rights", icon: Shield },
      { key: "/administration/preferences", label: "Preferences", icon: Settings },
      { key: "/administration/import", label: "Bulk Import", icon: Upload },
    ],
    reports: [
      { key: "/reports/useractivity", label: "User Activity", icon: Activity },
      { key: "/reports/activeusers", label: "Active Users", icon: UserCheck },
      { key: "/reports/userslist", label: "Users List", icon: Users },
    ],
  },
];
